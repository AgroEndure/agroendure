...
Your role is pivotal in ensuring the health and productivity of plants.
"""

# Streamlit UI setup
st.title("Plant Disease Analysis Tool")

st.write("Upload an image and analyze plant diseases with AI-generated recommendations.")
...
if uploaded_file is not None:
    try:
        ...
        st.text_area("AI Analysis Result", result, height=300)
